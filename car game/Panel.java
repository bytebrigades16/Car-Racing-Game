...
public class Panel extends JPanel implements KeyListener{
    ...
    Panel(int w, int h) {
        ...
        restartButton = new RestartButton("Restart", new ActionListener() {
            @Override
    ...
    private void addRandomCars(int count) {
        for (int i = 0; i < count; i++) {
            ...
            cars.add(new Car(lane, y, 105, 170, 5 + speed));
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        for(Car car : cars){
            ...
            if (isCollision(car)) {
                gameOver = true;
                repaint();
                return; // Stop checking further once a collision is detected
            }
    ...
    private void restartGame() {
        ...
        class Car{
            ...
            Car(int x, int y , int width , int height , int speed){
                ...
                image = new ImageIcon("car_up.png").getImage();
